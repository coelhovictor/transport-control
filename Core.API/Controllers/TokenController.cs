...
namespace Core.API.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        {
            var result = await _authentication.RegisterUser(userInfo.Email, userInfo.Password, userInfo.FirstName, 
                userInfo.LastName, userInfo.Birthdate, userInfo.Profession, userInfo.Location);
            if(!result.Success)
            {
                ModelState.AddModelError(string.Empty, "Invalid login attempt");
                return BadRequest(ModelState);
